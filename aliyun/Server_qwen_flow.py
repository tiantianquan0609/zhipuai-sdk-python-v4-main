...
print('您好！我是您的诊断咨询助手。请您输入企业名称以及装备领域诊断问卷的回答，我将为您提供贵公司装备能力的详细评估结果。问卷的回答请按照如下格式进行输入，示例如下：Vinda企业，A1: 5%，A2: 5%，A3: 5%，A4: 5%，A5: A')
...
for i in range(10):
    ...
    assistant_output = get_response_stream(messages)
    messages.append({'role': 'assistant', 'content': assistant_output})
    #print(f'\n诊断咨询助手：{assistant_output}')
    print('\n')
